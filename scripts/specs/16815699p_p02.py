"""Golden structure spec for 16815699P_CONTRATO.pdf page 2 (Condiciones económicas + firma).
...
reconocimiento de deuda, domicilio de pago (BANCO SANTANDER), derecho de
desistimiento prose, and the triple firma row (Prestatario / Fiador / Financiador)
with the standard CaixaBank footer + Logalty sidebar noise.
"""
...
STRUCTURE = [
        ...
        "children": [
            {
                ...
                "pairs": [
                    ...
                    {
                        "label": "Domicilio",
                        "value": "CL LEON Y CASTILLO 1 APDO. 000",
                        "y_hint": 382.6,
                        "x_hint": 309.9,
                    },
                    {
                        "label": "Localidad",
                        "value": "LAS PALMAS, LEON Y CASTIL",
                        "y_hint": 397.4,
                    },
                    {
                        "label": "Nº de cuenta",
                        "value": "ES96 0049 4991 0427 1620 1797",
                        "y_hint": 398.5,
                        "x_hint": 324.9,
                    },
                ],
    ...
    },
    {
        ...
        "text": (
            "En prueba de conformidad, firman las partes el presente contrato en 24 "
    ...
    },
    {
        ...
        "text": "@$FIRMATAG{<signature><id>1</id><width>44</width><height>7</height><nif>16815699P</nif></signature>}",
        "kind": "watermark",
        "y_hint": 658.1,
    },
    {
